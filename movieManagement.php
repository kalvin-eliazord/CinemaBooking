...
if(isset($_POST["updateButton"])) {
    if(!$_POST["name"] == ""){
        ...
        $name = $_POST["name"];
        $movie->updateMovie($name, $thumbnail, $preview, $category, $producerId);
        header("Location: movieManagement.php?id=".$movieId);
                ...
                <form method="POST">
                 <table>
                    ...
                    <tr>
                        ...
                        <td class ="table">
                            <?php
                            $producerId = $movie->getProducerId();
